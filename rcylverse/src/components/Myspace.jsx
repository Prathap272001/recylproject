...
function Myspace() {
    ...
    return (
        <div>
            <div className={`pop ${popup ? "pop-blur" : ""}`} >
                <Nav></Nav>
                ...
                <div className='inner-content'>
                    ...
                    <div className='work1'>
                        ...
                        <div className='inner-work1'>
                            <div className='work-content1'>
                                <IoDocumentTextOutline style={{ marginLeft: "20px", fontSize: "25px" }} />
                                <h3>Document 1</h3>
                                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            </div>
                            <div className='work-content1'>
                                <AiFillShopping style={{ marginLeft: "20px", fontSize: "25px" }} />
                                <h3>Document 2</h3>
                                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            </div>
                            <div className='work-content1'>
                    ...
                    <div onClick={() => setpopup(false)} className='project-list'>
                    ...
                    <div className='portfolio'>
                        ...
                        <div className='inner-portfolio'>
                            <a onClick={() => setpopup(!popup)}> <IoMdArrowDropdown style={{ marginBottom: "-4px" }} /> Drag and Drop Files</a>
                            <a> <MdFileUpload style={{ marginBottom: "-4px" }} /> Upload from MySpace</a>
                        </div>

                    </div>
                    <div onClick={() => {setpopup(false)}} className='sellorbuy'>
                ...
                {popup && (<div className='drag-popup '>
                    <Drag></Drag>
                </div>)}
        </div>
    )
